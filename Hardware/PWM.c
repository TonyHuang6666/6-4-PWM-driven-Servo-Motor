...
void PWM_Init(void)
{
	...
	TIM_TimeBaseInitStructure.TIM_Period = 20000 - 1;	//自动重装载值。ARR的值越大，频率越小
	TIM_TimeBaseInitStructure.TIM_Prescaler = 72 - 1;	//预分频值。PSC的值越大，频率越小
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_1;	//PA0复用了TIM2的OC1
